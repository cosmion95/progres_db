create table clienti(
 ...
 constraint clienti_telefon_uk unique (telefon),
 constraint clienti_cont_v check (cont_valid in ('D', 'N'))
);
comment on table clienti is 'Tabela care contine toti clientii inregistrati in sistem';
comment on table clienti.id is 'Identificator unic al clientului';